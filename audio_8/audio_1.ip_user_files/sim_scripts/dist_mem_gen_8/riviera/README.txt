...
#
# Generated by export_simulation on Wed Dec 06 15:54:04 -0600 2023
#
################################################################################
...
'-reset_run' switch to the './dist_mem_gen_8.sh' script.

./dist_mem_gen_8.sh -reset_run
...
./dist_mem_gen_8.sh -noclean_files

For more information on the script, please type './dist_mem_gen_8.sh -help'.
