...
HD_PWD='C:/Users/user/Desktop/fall2023/ece385/audio_8/audio_1.runs/dist_mem_gen_8_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dist_mem_gen_8.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dist_mem_gen_8.tcl
