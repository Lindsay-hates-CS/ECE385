...
HD_PWD='C:/Users/user/Desktop/fall2023/ece385/audio_8/audio_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log audio_toplevel.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source audio_toplevel.tcl -notrace
