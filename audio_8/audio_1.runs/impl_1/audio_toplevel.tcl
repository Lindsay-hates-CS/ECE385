...
namespace eval ::optrace {
  variable script "C:/Users/user/Desktop/fall2023/ece385/audio_8/audio_1.runs/impl_1/audio_toplevel.tcl"
...
OPTRACE "add files" START { }
  add_files -quiet C:/Users/user/Desktop/fall2023/ece385/audio_8/audio_1.runs/synth_1/audio_toplevel.dcp
...
OPTRACE "link_design" START { }
  link_design -top audio_toplevel -part xc7s50csga324-1 
...
OPTRACE "Opt Design: write_checkpoint" START { CHECKPOINT }
  write_checkpoint -force audio_toplevel_opt.dcp
OPTRACE "Opt Design: write_checkpoint" END { }
OPTRACE "opt_design reports" START { REPORT }
  create_report "impl_1_opt_report_drc_0" "report_drc -file audio_toplevel_drc_opted.rpt -pb audio_toplevel_drc_opted.pb -rpx audio_toplevel_drc_opted.rpx"
...
OPTRACE "Place Design: write_checkpoint" START { CHECKPOINT }
  write_checkpoint -force audio_toplevel_placed.dcp
OPTRACE "Place Design: write_checkpoint" END { }
OPTRACE "place_design reports" START { REPORT }
  create_report "impl_1_place_report_io_0" "report_io -file audio_toplevel_io_placed.rpt"
  create_report "impl_1_place_report_utilization_0" "report_utilization -file audio_toplevel_utilization_placed.rpt -pb audio_toplevel_utilization_placed.pb"
  create_report "impl_1_place_report_control_sets_0" "report_control_sets -verbose -file audio_toplevel_control_sets_placed.rpt"
...
OPTRACE "Post-Place Phys Opt Design: write_checkpoint" START { CHECKPOINT }
  write_checkpoint -force audio_toplevel_physopt.dcp
...
OPTRACE "Route Design: write_checkpoint" START { CHECKPOINT }
  write_checkpoint -force audio_toplevel_routed.dcp
OPTRACE "Route Design: write_checkpoint" END { }
OPTRACE "route_design reports" START { REPORT }
  create_report "impl_1_route_report_drc_0" "report_drc -file audio_toplevel_drc_routed.rpt -pb audio_toplevel_drc_routed.pb -rpx audio_toplevel_drc_routed.rpx"
  create_report "impl_1_route_report_methodology_0" "report_methodology -file audio_toplevel_methodology_drc_routed.rpt -pb audio_toplevel_methodology_drc_routed.pb -rpx audio_toplevel_methodology_drc_routed.rpx"
  create_report "impl_1_route_report_power_0" "report_power -file audio_toplevel_power_routed.rpt -pb audio_toplevel_power_summary_routed.pb -rpx audio_toplevel_power_routed.rpx"
  create_report "impl_1_route_report_route_status_0" "report_route_status -file audio_toplevel_route_status.rpt -pb audio_toplevel_route_status.pb"
  create_report "impl_1_route_report_timing_summary_0" "report_timing_summary -max_paths 10 -report_unconstrained -file audio_toplevel_timing_summary_routed.rpt -pb audio_toplevel_timing_summary_routed.pb -rpx audio_toplevel_timing_summary_routed.rpx -warn_on_violation "
  create_report "impl_1_route_report_incremental_reuse_0" "report_incremental_reuse -file audio_toplevel_incremental_reuse_routed.rpt"
  create_report "impl_1_route_report_clock_utilization_0" "report_clock_utilization -file audio_toplevel_clock_utilization_routed.rpt"
  create_report "impl_1_route_report_bus_skew_0" "report_bus_skew -warn_on_violation -file audio_toplevel_bus_skew_routed.rpt -pb audio_toplevel_bus_skew_routed.pb -rpx audio_toplevel_bus_skew_routed.rpx"
...
OPTRACE "route_design write_checkpoint" END { }
  write_checkpoint -force audio_toplevel_routed_error.dcp
...
OPTRACE "read constraints: write_bitstream" END { }
  set_property XPM_LIBRARIES {XPM_CDC XPM_MEMORY} [current_project]
  catch { write_mem_info -force -no_partial_mmi audio_toplevel.mmi }
OPTRACE "write_bitstream setup" END { }
OPTRACE "write_bitstream" START { }
  write_bitstream -force audio_toplevel.bit 
OPTRACE "write_bitstream" END { }
OPTRACE "write_bitstream misc" START { }
OPTRACE "read constraints: write_bitstream_post" START { }
OPTRACE "read constraints: write_bitstream_post" END { }
  catch {write_debug_probes -quiet -force audio_toplevel}
  catch {file copy -force audio_toplevel.ltx debug_nets.ltx}
